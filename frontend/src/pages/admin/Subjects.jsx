...
function AdminSubjects() {
  ...
  const handleSubmit = async () => {
    if (!form.name) {
      showAlert?.(t.admin?.enterName || "Fan nomini kiriting!")
      return
    }
    ...
    try {
      ...
      showAlert?.(t.admin?.subjectAdded || "Fan qo'shildi!")
      setShowModal(false)
    ...
    <div className="min-h-screen bg-slate-100 pb-24">
      ...
      <div className="bg-slate-800 px-4 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-white">{t.admin?.subjects || 'Fanlar'}</h1>
        </div>
        <button
      ...
      <div className="p-4 space-y-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-400">{t.admin?.totalSubjects || 'Jami fanlar'}</p>
          </div>
        </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {subject.short_name && (
                        <span className="text-sm text-slate-400">{subject.short_name}</span>
                      )}
                    </div>
                  </div>
                  <button
